...
export const LoginPage: React.FC = () => {
  return (
    <div className="min-h-screen min-h-[100dvh] w-full bg-[#f8fafc] flex flex-col lg:flex-row font-sans">
      ...
      <div className="lg:w-[38%] bg-gradient-to-br from-[#eff6ff] via-[#f0f7ff] to-[#e6f0fa] relative flex flex-col items-center justify-center p-4 sm:p-8 lg:p-12 overflow-hidden border-b lg:border-b-0 lg:border-r border-[#e2e8f0] shrink-0 py-6 sm:py-8 lg:py-12">
        ...
        <div className="absolute top-4 left-4 w-24 h-24 opacity-25 bg-[radial-gradient(#2563eb_1.5px,transparent_1.5px)] [background-size:12px_12px] pointer-events-none" />

        {/* Top-Right Soft Blue Ring Decoration */}
        <div className="absolute top-6 right-6 w-32 h-32 rounded-full border-[14px] border-blue-200/30 blur-xs pointer-events-none" />
        ...
        <div className="relative z-10 text-center max-w-sm mx-auto space-y-3 sm:space-y-4">
          <div className="mx-auto w-10 h-10 sm:w-16 sm:h-16 flex items-center justify-center">
            <svg className="w-10 h-10 sm:w-16 sm:h-16 text-[#2563eb]" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center justify-center">
            <span className="text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[#0f172a]">
              Intern<span className="text-[#2563eb]">IQ</span>
            </span>
          </div>

          <p className="text-xs sm:text-base font-medium text-[#64748b] leading-snug">
      ...
      <div className="flex-1 lg:w-[62%] flex items-center justify-center p-3 sm:p-8 lg:p-14 relative bg-[#f8fafc] pb-6 sm:pb-8">
        <div className="w-full max-w-xl bg-white border border-[#e2e8f0] rounded-2xl sm:rounded-3xl p-4 sm:p-8 lg:p-10 shadow-lg shadow-slate-200/50 relative z-10">
